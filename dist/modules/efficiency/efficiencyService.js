...
class EfficiencyService {
    constructor() {
        ...
        this.BATTERY_CAPACITY = 75; // kWh
        this.AVG_CONSUMPTION = 16.5; // kWh/100km
        this.KWH_PRICE = 0.85; // Preço médio do kWh no Brasil (R$)
    }
    /**
...
exports.default = new EfficiencyService();
